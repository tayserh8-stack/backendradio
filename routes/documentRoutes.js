...
const { documentAccessMiddleware } = require('../middleware/documentAccessMiddleware');
const {
  uploadDocument,
  getMyDocuments,
  getDocumentById,
...
// Get document by ID
router.get('/:id', protect, documentAccessMiddleware, getDocumentById);

// Update document metadata
router.put('/:id', protect, updateDocument);

// Delete document
router.delete('/:id', protect, documentAccessMiddleware, deleteDocument);
